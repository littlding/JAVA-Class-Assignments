...
public class LibraryTest {
	...
	public static void main(String[] args) {
		...
		lib.checkout(9781843190011L, "Alan Burt", 11, 12, 2008);
		lib.checkout(9781843190042L, "Meacham", 1, 24, 2012);

		ArrayList<LibraryBook> libraryCopy = lib.getOrderedByAuthor();

		if (libraryCopy.get(0).getAuthor().equals("Alan Burt Akers")) {
			System.out.println("TEST SUCCESSED");
		}

		if (libraryCopy.get(libraryCopy.size() - 1).getAuthor().equals("William Fitzmaurice")) {
			System.out.println("TEST SUCCESSED");
		}

		ArrayList<LibraryBook> libraryCopy1 = lib.getOverdueList(1, 1, 2005);

		if (libraryCopy1.size() == 3) {
			System.out.println("TEST SUCCESSED");
		}

		if (libraryCopy1.get(0).getAuthor().equals("Alan Burt Akers")) {
			System.out.println("TEST SUCCESSED");
		}

		ArrayList<LibraryBook> libraryCopy2 = lib.getOverdueList(1, 10, 2008);

		if (libraryCopy2.size() == 2) {
			System.out.println("TEST SUCCESSED");
		}

		ArrayList<LibraryBook> libraryCopy3 = lib.getOverdueList(1, 1, 2012);

		if (libraryCopy3.size() == 1) {
			System.out.println("TEST SUCCESSED");
		}
