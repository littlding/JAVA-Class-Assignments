...
public class LibraryGenericTest {
  ...
  public static void main(String[] args) {
    ...
    ArrayList<LibraryBook<String>> inventory = new ArrayList<LibraryBook<String>>();
    inventory= lib1.getInventoryList();
    for (LibraryBook<String> Ib : inventory) {
    	System.out.println(Ib.getIsbn());
    }
    if (!(inventory.get(0).getIsbn()<inventory.get(1).getIsbn() && inventory.get(1).getIsbn()<inventory.get(2).getIsbn() ))
       System.out.println("TEST FAILED: getInventoryList()");
