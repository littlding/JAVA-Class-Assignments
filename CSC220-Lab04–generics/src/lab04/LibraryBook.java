...
public class LibraryBook<Type> extends Book{
	...
	public String toString() {
		if(dueDate != null) {
			return  dueDate.get(GregorianCalendar.YEAR)+ "-"+ dueDate.get(GregorianCalendar.MONTH)+"-"+ dueDate.get(GregorianCalendar.DATE) + "    " + super.getIsbn() + ", " + super.getAuthor() + ", \"" + super.getTitle() + "\"";
		}else {
			return  super.getIsbn() + ", " + super.getAuthor() + ", \"" + super.getTitle() + "\"";
		}
